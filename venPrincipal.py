...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/a20evansg/.designer/backup/img/Inmoteis.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.btnCalendarcli.setSizeIncrement(QtCore.QSize(32, 0))
        self.btnCalendarcli.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.PreventContextMenu)
